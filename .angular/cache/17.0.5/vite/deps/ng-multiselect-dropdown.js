...
function MultiSelectComponent_li_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("ngModelChange", function MultiSelectComponent_li_11_Template_input_ngModelChange_1_listener($event) {
      ...
      return ɵɵresetView(ctx_r14.filter.text = $event);
  ...
  if (rf & 2) {
    ...
    ɵɵadvance(1);
    ɵɵproperty("readOnly", ctx_r4.disabled)("placeholder", ctx_r4._settings.searchPlaceholderText)("ngModel", ctx_r4.filter.text);
  }
}
